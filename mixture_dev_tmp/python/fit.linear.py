...
parser = argparse.ArgumentParser(
                    prog = sys.argv[0],
                    description = 'Prints the coefficients of a linear fit of the given column of a file.',
                    epilog='Printing format: intercept | intercept error \\n slope | slope error.\n'
)
...
if args.dy>=0:
	dy = dy[n0:n-n1]
	popt,pcov = curve_fit(f, x,y, sigma=dy, p0=p0, maxfev=10000)
else:
	popt,pcov = curve_fit(f, x,y, sigma=None, p0=p0, maxfev=10000)
