...
echo
../../bin/mdtraj -xyz_cp2k octa.xyz -box1 12 -rcut octa.rcut -rdf 0.02 -1 -adf 0.01 -edq -bo -l 4 -image_convention 1
../../bin/mdtraj -xyz_cp2k octa.xyz -box1 12 -rcut octa.rcut -rdf 0.02 -1 -adf 0.01 -edq -bo -l 6 -image_convention 1
