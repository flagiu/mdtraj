...
${PATH_TO_MDTRAJ}/bin/mdtraj -xyz traj.liq.xyz.save -box6 8.8 -3.5 2.1 7.4 1.3 10.0 -rdf 0.02 -tag "liq"
printf "Exit $? \n\n"
printf " *** Does the liquid g(r) converge to 1 at large r? *** \n\n"

echo "Test crystallized RDF:"
${PATH_TO_MDTRAJ}/bin/mdtraj -xyz traj.xtal.xyz.save -box6 8.8 -3.5 2.1 7.4 1.3 10.0 -rdf 0.02 -tag "xtal"
printf "Exit $? \n\n"
